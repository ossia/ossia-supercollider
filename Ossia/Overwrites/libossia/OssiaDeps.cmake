...
if(ANDROID)
  ...
  include_directories("/opt/boost_1_${BOOST_MINOR}_1")
else()
  ...
  if ( NOT Boost_FOUND )
    set(BOOST_VERSION "boost_1_${BOOST_MINOR}_1")
    if ( NOT EXISTS "${OSSIA_3RDPARTY_FOLDER}/${BOOST_VERSION}/")
      ...
      if(WIN32)
        ...
        file(DOWNLOAD
          https://dl.bintray.com/boostorg/release/1.${BOOST_MINOR}.1/source/${BOOST_VERSION}.zip
        ...
        file(DOWNLOAD
          https://dl.bintray.com/boostorg/release/1.${BOOST_MINOR}.1/source/${BOOST_VERSION}.tar.gz
